...
<body>
    ...
    <section id="hero">
        ...
        <div class="hero-content">
            <div class="badge">v1.0.0 &nbsp;·&nbsp; Open Source</div>
    ...
    <section id="about" class="content-section">
        <div class="container">
            ...
            <p class="section-body">
                This project is a starting point for building something great. Edit this page to describe what your project does, who it's for, and why it matters. The 3D scene above is rendered with <strong>Three.js</strong> — fully customisable in <code>assets/js/scene.js</code>.
            </p>
            <div class="cards">
                <div class="card">
                    <div class="card-icon">&#9651;</div>
                    <h3>Fast</h3>
                    <p>Pure static files — no build step needed. Loads instantly in any browser.</p>
                </div>
                <div class="card">
                    <div class="card-icon">&#9670;</div>
                    <h3>3D Ready</h3>
    ...
    <section id="features" class="content-section alt-bg">
        <div class="container">
            ...
            <ul class="feature-list">
                ...
                <li><span class="check">&#10003;</span> Responsive layout — looks great on mobile &amp; desktop</li>
    ...
    <section id="getting-started" class="content-section">
        <div class="container">
            ...
            <p class="section-body">Clone the repository and open <code>README.md</code> in your browser — or deploy straight to Replit.</p>
...
<span class="c"># Open locally (no build step needed)</span>
...
<span class="k">const</span> geo = <span class="k">new</span> THREE.<span class="fn">IcosahedronGeometry</span>(<span class="n">1</span>, <span class="n">0</span>);

<span class="c">// Change colour palette</span>
<span class="k">const</span> colors = [<span class="s">'#667eea'</span>, <span class="s">'#764ba2'</span>, <span class="s">'#f093fb'</span>];

<span class="c">// Change particle count</span>
<span class="k">const</span> COUNT = <span class="n">60</span>;</code></pre>
            </div>
        </div>
    </section>
    ...
    <footer>
        <div class="container">
            <p>Built with &#9829; and Three.js &nbsp;·&nbsp; Edit this page in <code>README.md</code></p>
        </div>
    </footer>
